...
from motrix_envs.locomotion.vbot.cfg import VbotWalkNpEnvCfg
from motrix_envs.math.quaternion import Quaternion
from motrix_envs.np.env import NpEnv, NpEnvState


@registry.env("vbot-flat-terrain-walk", sim_backend="np")
class VbotWalkTask(NpEnv):
    _init_dof_pos: np.ndarray
    _init_dof_vel: np.ndarray

    def __init__(self, cfg: VbotWalkNpEnvCfg, num_envs=1):
    ...
    def _init_buffer(self):
        cfg = self._cfg
        assert isinstance(cfg, VbotWalkNpEnvCfg)
        # init buffers
