...
@dataclass
class ControlConfig:
    stiffness = 60  # [N*m/rad] vbot motors are smaller than go1
...
@registry.envcfg("vbot-flat-terrain-walk")
@dataclass
class VbotWalkNpEnvCfg(EnvCfg):
    max_episode_seconds: float = 20.0
    model_file: str = os.path.dirname(__file__) + "/xmls/scene_vbot_flat.xml"
